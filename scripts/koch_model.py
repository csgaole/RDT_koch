...
KOCH_STATE_INDICES = [
    STATE_VEC_IDX_MAPPING[f"arm_joint_{i}_pos"] for i in range(5)
] + [
    ...
    def _unformat_action_to_joint(self, action):
        ...
        Returns:
            joints (torch.Tensor): The unformatted robot joint action. 
                qpos ([B, N, 14]).
        """
        action_indices = KOCH_STATE_INDICES
